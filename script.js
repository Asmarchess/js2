let KreditCalc = (emekhaqqi, istenilenmebleg, istenilenmuddet) => {
    const MAXMUDDET = 36
    ...
    if (istenilenmuddet > MAXMUDDET || istenilenmebleg > MAXMEBLEG || ayligOdenish > MAXODENIS) {
...
console.log(KreditCalc(200, 600, 15));
